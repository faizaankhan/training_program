...
question1Exam1 = Question.create(exam_id: exam1.id , question_description: "What things we can define in the model? ")
question2Exam1 = Question.create(exam_id: exam1.id , question_description: "Why is this for :\n jQuery.ajax({\r\n          url: 'main/getlocation',\r\n          data: \"latitude=\" + latitude + \"&longitude=\" + longitude,\r\n          type: \"POST\",\r\n          success: function(data) {\r\n            alert(\"Successful\");\r\n          },\r\n          failure: function() {\r\n            alert(\"Unsuccessful\");\r\n          }\r\n        });")
